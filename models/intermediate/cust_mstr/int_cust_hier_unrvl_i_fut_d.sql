...
-- ===================================================================================================================================================================================================================
 ...
 Revisions  :
 Version     to_date        Author           Description
 ---------  ----------  ---------------  ------------------------------------------------------------------
...
    where
        datab <=  '9999-12-31'  and datbi >=  '9999-12-31' and hityp = 'D'
    group by
...
cust_hier_unrvl_i_fut_d as (
    --level 1
    select to_date('99991231','YYYYMMDD') as hier_dt, lv1.hityp as hier_id, lv1.kunnr as level1_nbr, n1.name1 as level1_nm,
    ...
    '1' as lst_level_nbr, lv1.kunnr as lst_level_cust_nbr,
    ...
    select to_date('99991231','YYYYMMDD') as hier_dt, lv1.hityp as hier_id, lv1.kunnr as level1_nbr, n1.name1 as level1_nm,
    lv2.kunnr as level2_nbr, n2.name1 as level2_nm,
    ' ' as level3_nbr, ' ' as level3_nm,
    ' ' as level4_nbr, ' 'as level4_nm,
    ' ' as level5_nbr, ' ' as level5_nm,
    ' ' as level6_nbr, ' ' as level6_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '2' as lst_level_nbr, lv2.kunnr as lst_level_cust_nbr,
    ...
    select to_date('99991231','YYYYMMDD') as hier_dt, lv1.hityp as hier_id, lv1.kunnr as level1_nbr, n1.name1 as level1_nm,
    lv2.kunnr as level2_nbr, n2.name1 as level2_nm,
    lv3.kunnr as level3_nbr, n3.name1 as level3_nm,
    ' ' as level4_nbr, ' 'as level4_nm,
    ' ' as level5_nbr, ' ' as level5_nm,
    ' ' as level6_nbr, ' ' as level6_nm,
    ' ' as level7_nbr, ' ' as level7_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '3' as lst_level_nbr, lv3.kunnr as lst_level_cust_nbr,
    ...
    lv2.kunnr as level2_nbr, n2.name1 as level2_nm,
    lv3.kunnr as level3_nbr, n3.name1 as level3_nm,
    lv4.kunnr as level4_nbr, n4.name1 as level4_nm,
    ' ' as level5_nbr, ' ' as level5_nm,
    ' ' as level6_nbr, ' ' as level6_nm,
    ' ' as level7_nbr, ' ' as level7_nm,
    ' ' as level8_nbr, ' ' as level8_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '4' as lst_level_nbr, lv4.kunnr as lst_level_cust_nbr,
    ...
    lv3.kunnr as level3_nbr, n3.name1 as level3_nm,
    lv4.kunnr as level4_nbr, n4.name1 as level4_nm,
    lv5.kunnr as level4_nbr, n5.name1 as level5_nm,
    ' ' as level6_nbr, ' ' as level6_nm,
    ' ' as level7_nbr, ' ' as level7_nm,
    ' ' as level8_nbr, ' ' as level8_nm,
    ' ' as level9_nbr, ' ' as level9_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '5' as lst_level_nbr, lv5.kunnr as lst_level_cust_nbr,
    ...
    lv3.kunnr as level3_nbr, n3.name1 as level3_nm,
    lv4.kunnr as level4_nbr, n4.name1 as level4_nm,
    lv5.kunnr as level5_nbr, n5.name1 as level5_nm,
    lv6.kunnr as level6_nbr, n6.name1 as level6_nm,
    ' ' as level7_nbr, ' ' as level7_nm,
    ' ' as level8_nbr, ' ' as level8_nm,
    ' ' as level9_nbr, ' ' as level9_nm,
    ' ' as level10_nbr, ' ' as level10_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '6' as lst_level_nbr, lv6.kunnr as lst_level_cust_nbr,
    ...
    lv5.kunnr as level5_nbr, n5.name1 as level5_nm,
    lv6.kunnr as level6_nbr, n6.name1 as level6_nm,
    lv7.kunnr as level7_nbr, n7.name1 as level7_nm,
    ' ' as level8_nbr, ' ' as level8_nm,
    ' ' as level9_nbr, ' ' as level9_nm,
    ' ' as level10_nbr, ' ' as level10_nm,
    ' ' as level11_nbr, ' ' as level11_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '7' as lst_level_nbr, lv7.kunnr as lst_level_cust_nbr,
    ...
    lv6.kunnr as level6_nbr, n6.name1 as level6_nm,
    lv7.kunnr as level7_nbr, n7.name1 as level7_nm,
    lv8.kunnr as level8_nbr, n8.name1 as level8_nm,
    ' ' as level9_nbr, ' ' as level9_nm,
    ' ' as level10_nbr, ' ' as level10_nm,
    ' ' as level11_nbr, ' ' as level11_nm,
    ' ' as level12_nbr, ' ' as level12_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '8' as lst_level_nbr, lv8.kunnr as lst_level_cust_nbr,
    ...
    lv7.kunnr as level7_nbr, n7.name1 as level7_nm,
    lv8.kunnr as level8_nbr, n8.name1 as level8_nm,
    lv9.kunnr as level9_nbr, n9.name1 as level9_nm,
    ' ' as level10_nbr, ' ' as level10_nm,
    ' ' as level11_nbr, ' ' as level11_nm,
    ' ' as level12_nbr, ' ' as level12_nm,
    ' ' as level13_nbr, ' ' as level13_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '9' as lst_level_nbr, lv9.kunnr as lst_level_cust_nbr,
    ...
    lv8.kunnr as level8_nbr, n8.name1 as level8_nm,
    lv9.kunnr as level9_nbr, n9.name1 as level9_nm,
    lv10.kunnr as level10_nbr, n10.name1 as level10_nm,
    ' ' as level11_nbr, ' ' as level11_nm,
    ' ' as level12_nbr, ' ' as level12_nm,
    ' ' as level13_nbr, ' ' as level13_nm,
    ' ' as level14_nbr, ' ' as level14_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '10' as lst_level_nbr, lv10.kunnr as lst_level_cust_nbr,
    ...
    lv9.kunnr as level9_nbr, n9.name1 as level9_nm,
    lv10.kunnr as level10_nbr, n10.name1 as level10_nm,
    lv11.kunnr as level11_nbr, n11.name1 as level11_nm,
    ' ' as level12_nbr, ' ' as level12_nm,
    ' ' as level13_nbr, ' ' as level13_nm,
    ' ' as level14_nbr, ' ' as level14_nm,
    ' ' as level15_nbr, ' ' as level15_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '11' as lst_level_nbr, lv11.kunnr as lst_level_cust_nbr,
    ...
    lv10.kunnr as level10_nbr, n10.name1 as level10_nm,
    lv11.kunnr as level11_nbr, n11.name1 as level11_nm,
    lv12.kunnr as level12_nbr, n12.name1 as level12_nm,
    ' ' as level13_nbr, ' ' as level13_nm,
    ' ' as level14_nbr, ' ' as level14_nm,
    ' ' as level15_nbr, ' ' as level15_nm,
    ' ' as level16_nbr, ' ' as level16_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '12' as lst_level_nbr, lv12.kunnr as lst_level_cust_nbr,
    ...
    lv11.kunnr as level11_nbr, n11.name1 as level11_nm,
    lv12.kunnr as level12_nbr, n12.name1 as level12_nm,
    lv13.kunnr as level13_nbr, n13.name1 as level13_nm,
    ' ' as level14_nbr, ' ' as level14_nm,
    ' ' as level15_nbr, ' ' as level15_nm,
    ' ' as level16_nbr, ' ' as level16_nm,
    ' ' as level17_nbr, ' ' as level17_nm,
    ...
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '13' as lst_level_nbr, lv13.kunnr as lst_level_cust_nbr,
    ...
    lv12.kunnr as level12_nbr, n12.name1 as level12_nm,
    lv13.kunnr as level13_nbr, n13.name1 as level13_nm,
    lv14.kunnr as level14_nbr, n14.name1 as level14_nm,
    ' ' as level15_nbr, ' ' as level15_nm,
    ' ' as level16_nbr, ' ' as level16_nm,
    ' ' as level17_nbr, ' ' as level17_nm,
    ' ' as level18_nbr, ' ' as level18_nm,
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '14' as lst_level_nbr, lv14.kunnr as lst_level_cust_nbr,
    ...
    lv13.kunnr as level13_nbr, n13.name1 as level13_nm,
    lv14.kunnr as level14_nbr, n14.name1 as level14_nm,
    lv15.kunnr as level15_nbr, n15.name1 as level15_nm,
    ' ' as level16_nbr, ' ' as level16_nm,
    ' ' as level17_nbr, ' ' as level17_nm,
    ' ' as level18_nbr, ' ' as level18_nm,
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '15' as lst_level_nbr, lv15.kunnr as lst_level_cust_nbr,
    ...
    lv14.kunnr as level14_nbr, n14.name1 as level14_nm,
    lv15.kunnr as level15_nbr, n15.name1 as level15_nm,
    lv16.kunnr as level16_nbr, n16.name1 as level16_nm,
    ' ' as level17_nbr, ' ' as level17_nm,
    ' ' as level18_nbr, ' ' as level18_nm,
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '16' as lst_level_nbr, lv16.kunnr as lst_level_cust_nbr,
    ...
    lv15.kunnr as level15_nbr, n15.name1 as level15_nm,
    lv16.kunnr as level16_nbr, n16.name1 as level16_nm,
    lv17.kunnr as level17_nbr, n17.name1 as level17_nm,
    ' ' as level18_nbr, ' ' as level18_nm,
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '17' as lst_level_nbr, lv17.kunnr as lst_level_cust_nbr,
    ...
    lv16.kunnr as level16_nbr, n16.name1 as level16_nm,
    lv17.kunnr as level17_nbr, n17.name1 as level17_nm,
    lv18.kunnr as level18_nbr, n18.name1 as level18_nm,
    ' ' as level19_nbr, ' ' as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '18' as lst_level_nbr, lv18.kunnr as lst_level_cust_nbr,
    ...
    lv17.kunnr as level17_nbr, n17.name1 as level17_nm,
    lv18.kunnr as level18_nbr, n18.name1 as level18_nm,
    lv19.kunnr as level19_nbr, n19.name1 as level19_nm,
    ' ' as level20_nbr, ' ' as level20_nm,
    '19' as lst_level_nbr, lv19.kunnr as lst_level_cust_nbr,
    ...
    lv18.kunnr as level18_nbr, n18.name1 as level18_nm,
    lv19.kunnr as level19_nbr, n19.name1 as level19_nm,
    lv20.kunnr as level20_nbr, n20.name1 as level20_nm,
    '20' as lst_level_nbr, lv20.kunnr as lst_level_cust_nbr,
...
select * from cust_hier_unrvl_i_fut_d